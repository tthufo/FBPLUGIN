...
- (CGSize)countScreenSize
{
    ...
    CGFloat screenWidthSize = [UIScreen mainScreen].bounds.size.width;
    CGFloat screenHeightSize = [UIScreen mainScreen].bounds.size.height;
    
    UIInterfaceOrientation interfaceOrientation = [[UIApplication sharedApplication] statusBarOrientation];
    if (UIInterfaceOrientationIsLandscape(interfaceOrientation)) {
        CGFloat tmp = screenWidthSize;
        screenWidthSize = screenHeightSize;
        screenHeightSize = tmp;
    }
    
    return CGSizeMake(screenWidthSize, screenHeightSize);
}
